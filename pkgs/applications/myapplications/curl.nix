...
assert tlsSupport -> sslSupport == false;
...
stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    ...
    sha256 = "1hqw6210ky3llavpc6iihlyi64k4plgrg03idkbdvzkaymggiars";
  };
  ...
  '';
  configureFlags = [
      ( if tlsSupport then "--with-gnutls=${gnutls}" else "--without-gnutls" )
